...
for i in range(num_):
    ...
    df = pd.read_csv("../Data/VCF/"+"output_"+str(i)+".csv",header=None)
    ...
    print("Parsing, Window-based sorting and resizing", i,d.shape)
    pd.DataFrame(d).to_csv("../Data/VCF/"+"output_"+str(i)+".csv")
