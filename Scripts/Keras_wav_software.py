...
np.savetxt("../Data/Results/Nonlim_Pred_wav_"+str(align_val)+".csv", p, fmt='%.18e', delimiter=' ', newline='\n', header='', footer='', comments='# ', encoding=None)


# In[37]:


np.savetxt("../Data/Results/Nonlin_Prob_wav_"+str(align_val)+".csv", l, fmt='%.18e', delimiter=' ', newline='\n', header='', footer='', comments='# ', encoding=None)
...
np.savetxt("../Data/Results/Nonlin_cm_wav_"+str(align_val)+".csv", c1, delimiter=' ', newline='\n', header='', footer='', comments='# ', encoding=None)
