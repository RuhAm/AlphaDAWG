...
# Save results
np.savetxt(f"../Data/Results/Nonlim_Pred_wav_{align_val}.csv", p, fmt='%.18e', delimiter=' ')
np.savetxt(f"../Data/Results/Nonlin_Prob_wav_{align_val}.csv", l, fmt='%.18e', delimiter=' ')
c1 = confusion_matrix(y1, p)
np.savetxt(f"../Data/Results/Nonlin_cm_wav_{align_val}.csv", c1, delimiter=' ')
