...
np.savetxt("../Data/Results/Nonlin_Preds_CW_"+str(align_val)+".csv", p, fmt='%.18e', delimiter=' ', newline='\n', header='', footer='', comments='# ', encoding=None)


# In[88]:


np.savetxt("../Data/Results/Nonlin_Prob_CW_"+str(align_val)+".csv", l, fmt='%.18e', delimiter=' ', newline='\n', header='', footer='', comments='# ', encoding=None)
...
np.savetxt("../Data/Results/Nonlin_CM_CW_"+str(align_val)+".csv", c1, delimiter=' ', newline='\n', header='', footer='', comments='# ', encoding=None)
